  ...
  return (
    <div className="grid gap-4 md:grid-cols-3">
      <MotionCard>
        <CardContent className="p-6">
          <div className="flex items-center gap-3">
            <div className={`rounded-full p-2 bg-gradient-to-br ${iconColors.total}`}>
      ...
      <MotionCard delay={0.1}>
        <CardContent className="p-6">
          <div className="flex items-center gap-3">
            <div className={`rounded-full p-2 bg-gradient-to-br ${iconColors.eth}`}>
      ...
      <MotionCard delay={0.2}>
        <CardContent className="p-6">
          <div className="flex items-center gap-3">
            <div className={`rounded-full p-2 bg-gradient-to-br ${iconColors.sol}`}>
